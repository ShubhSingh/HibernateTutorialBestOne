...
public class TestEvent {
	...
	public static void main(String[] args) {
		...
		// Since mappedBy is added to Event Entity Delegate owns ManyToMany Relationship that's why only 
		// given below relationships will be persisted whereas above given relationships will not be persisted.
